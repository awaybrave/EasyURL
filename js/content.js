var config = {
	"name": "content",
	"urlTemplate": "<div class='url_wrapper'><ul class='url_list'><%for(var i=0;i<this.urls.length;i++){%><li class='info-block'><span class='link-block' title=<%=this.urls[i].link%>><%=this.urls[i].title%></span><span class='del-url-btn'>删除</span></li><%}%></ul><div class='kwj-btn'><span class='save'>保存</span><span class='cancel'>取消</span></div></div>",
